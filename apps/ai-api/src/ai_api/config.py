...
SUPPLIER_CRAWL_ENABLED = _env_flag("SUPPLIER_CRAWL_ENABLED")
SUPPLIER_CRAWL_MAX_PAGES = int(os.getenv("SUPPLIER_CRAWL_MAX_PAGES", "3"))
SUPPLIER_CRAWL_TIMEOUT_S = int(os.getenv("SUPPLIER_CRAWL_TIMEOUT_S", "20"))
SUPPLIER_CRAWL_MAX_CHARS = int(os.getenv("SUPPLIER_CRAWL_MAX_CHARS", "8000"))
